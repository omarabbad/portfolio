...
const palettes: Record<ProductCardColor, {
    ...
    blue: {
        ...
        highlight: '#2D5BFF',
        glow:      '#79A6FF',
        blobA:     'rgba(45,91,255,0.7)',
        blobB:     'rgba(121,166,255,0.5)',
        shadow:    '0 30px 80px rgba(14,43,255,0.4)',
    },
    green: {
        bg:        '#0B7C47',
        highlight: '#1BAF6F',
        glow:      '#7BE3B2',
        blobA:     'rgba(27,175,111,0.7)',
        blobB:     'rgba(123,227,178,0.5)',
        shadow:    '0 30px 80px rgba(11,124,71,0.4)',
    },
    pink: {
        bg:        '#C61A73',
        highlight: '#FF4BA0',
        glow:      '#FF90C8',
        blobA:     'rgba(255,75,160,0.7)',
        blobB:     'rgba(255,144,200,0.5)',
        shadow:    '0 30px 80px rgba(198,26,115,0.4)',
    },
    purple: {
        bg:        '#5C2BFF',
        highlight: '#8F66FF',
        glow:      '#C7B5FF',
        blobA:     'rgba(143,102,255,0.7)',
        blobB:     'rgba(199,181,255,0.5)',
        shadow:    '0 30px 80px rgba(92,43,255,0.4)',
    },
};
